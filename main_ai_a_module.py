...
class MenuDataPreprocessor:
    ...
    def load_nutrition_data(self, csv_path: str = None):
        ...
        if csv_path and os.path.exists(csv_path):
            ...
            df = pd.DataFrame([
                # 영양성분표 1 (한식)
                {'제품명': '치킨 텐더바이트', '식당명': '브랜드 A', '중량': 16, '열량': 222, '탄백질': 35, '포화지방': 2, '당류': 4, '나트륨': 222,
                 '가격': 6500, '카테고리': '양식', '태그': '고단백,가벼운'},
                {'제품명': '치킨 마리네이드 샐러드', '식당명': '브랜드 A', '중량': 74, '열량': 492, '탄백질': 44, '포화지방': 6, '당류': 1, '나트륨': 492,
                 '가격': 8500, '카테고리': '양식', '태그': '고단백,샐러드'},
                {'제품명': '더블 치킨 타르타르', '식당명': '브랜드 A', '중량': 71, '열량': 615, '탄백질': 71, '포화지방': 5, '당류': 10, '나트륨': 615,
                 '가격': 9000, '카테고리': '양식', '태그': '든든한,고단백'},
                {'제품명': '치킨 칠리 샐러드', '식당명': '브랜드 A', '중량': 88, '열량': 591, '탄백질': 44, '포화지방': 7, '당류': 10, '나트륨': 591,
                 '가격': 8500, '카테고리': '양식', '태그': '샐러드,고단백'},
                {'제품명': '비프 칠리 샐러드', '식당명': '브랜드 A', '중량': 89, '열량': 731, '탄백질': 51, '포화지방': 19, '당류': 9, '나트륨': 731,
                 '가격': 9500, '카테고리': '양식', '태그': '든든한,고단백'},

                # 영양성분표 2 (서브웨이 스타일)
                {'제품명': '스파이시 바비큐', '식당명': '샌드위치 전문점', '중량': 256, '열량': 374, '탄백질': 25.2, '포화지방': 7.4, '당류': 15.0,
                 '나트륨': 903, '가격': 6500, '카테고리': '양식', '태그': '샌드위치,간편'},
                {'제품명': '스파이시 쉬림프', '식당명': '샌드위치 전문점', '중량': 213, '열량': 245, '탄백질': 16.5, '포화지방': 0.9, '당류': 9.1,
                 '나트륨': 570, '가격': 7000, '카테고리': '양식', '태그': '샌드위치,가벼운,저칼로리'},
                {'제품명': '스파이시 이탈리안', '식당명': '샌드위치 전문점', '중량': 224, '열량': 464, '탄백질': 20.7, '포화지방': 9.1, '당류': 8.7,
                 '나트륨': 1250, '가격': 6500, '카테고리': '양식', '태그': '샌드위치,든든한'},
                {'제품명': 'K-바비큐', '식당명': '샌드위치 전문점', '중량': 256, '열량': 372, '탄백질': 25.6, '포화지방': 2.1, '당류': 14.7,
                 '나트륨': 899, '가격': 7500, '카테고리': '양식', '태그': '샌드위치,한국풍'},

                # 추가 샘플 (다양한 카테고리)
                {'제품명': '김치찌개', '식당명': '한식당 A', '중량': 350, '열량': 450, '탄백질': 25, '포화지방': 8, '당류': 5, '나트륨': 1200,
                 '가격': 7000, '카테고리': '한식', '태그': '국물,따뜻한,든든한'},
                {'제품명': '비빔밥', '식당명': '한식당 A', '중량': 400, '열량': 550, '탄백질': 20, '포화지방': 6, '당류': 12, '나트륨': 800,
                 '가격': 8000, '카테고리': '한식', '태그': '건강한,영양균형'},
                {'제품명': '제육볶음', '식당명': '한식당 B', '중량': 300, '열량': 620, '탄백질': 35, '포화지방': 15, '당류': 18, '나트륨': 1500,
                 '가격': 8500, '카테고리': '한식', '태그': '든든한,고단백'},
                {'제품명': '냉면', '식당명': '한식당 C', '중량': 450, '열량': 420, '탄백질': 15, '포화지방': 3, '당류': 10, '나트륨': 900,
                 '가격': 9000, '카테고리': '한식', '태그': '시원한,여름'},
                {'제품명': '돈까스', '식당명': '일식당 A', '중량': 350, '열량': 750, '탄백질': 30, '포화지방': 20, '당류': 8, '나트륨': 950,
                 '가격': 9000, '카테고리': '일식', '태그': '튀김,든든한'},
                {'제품명': '라멘', '식당명': '일식당 B', '중량': 500, '열량': 650, '탄백질': 28, '포화지방': 18, '당류': 6, '나트륨': 2000,
